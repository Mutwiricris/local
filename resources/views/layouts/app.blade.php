...
{{--            </nav>--}}
{{--        @endif--}}
<nav class="bg-white fixed w-full  shadow-md border-gray-200">
    <div class="max-w-7xl font-medium mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="hidden md:flex items-center space-x-1">
                <div class="flex space-x-4 items-center">
                    <!-- Navigation Items -->
                    <button class="px-3 py-2 text-gray-700 hover:text-gray-900 flex items-center">
                        How to order
                ...
                @if (Route::has('login'))
                    ...
                    @else
                    <a href="{{ route('login') }}" class="px-4 py-2 text-blue-600 hover:text-blue-700 flex items-center">
                        <i class="fas fa-right-to-bracket mr-2"></i>
                        Login
                    </a>
                        @if (Route::has('register'))

                    <a  href="{{ route('register') }}" class="px-4 py-2 bg-blue-600 text-white rounded-md flex items-center">
                        Get Started
    ...
    <div class="hidden md:hidden">
        <div class="px-2 pt-2 pb-3 space-y-1">
            <a href="#" class="block px-3 py-2 text-gray-600 hover:text-gray-900">How to order</a>
            <a href="#" class="block px-3 py-2 text-gray-600 hover:text-gray-900">writing help</a>
            <a href="#" class="block px-3 py-2 text-gray-600 hover:text-gray-900">Company</a>
            <a href="#" class="block px-3 py-2 text-gray-600 hover:text-gray-900">Why us</a>
            <a href="#" class="block px-3 py-2 text-gray-600 hover:text-gray-900">witers</a>
            <div class="mt-4 space-y-2">
                <button class="w-full px-4 py-2 text-blue-600 border border-blue-600 rounded-md">Login</button>
                {{--                <button class="w-full px-4 py-2 text-blue-600 border border-blue-600 rounded-md">Book a demo</button>--}}
                <button class="w-full px-4 py-2 bg-blue-600 text-white rounded-md">Get Started</button>
            </div>
        </div>
    </div>
</nav>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
            <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                <a href="/"  class="flex justify-center lg:justify-start">
                    <img src="{{asset('images/logo.png')}}" alt="4scholars" class="h-24 w-24">
                ...
                <div class="flex flex-col md:flex-row items-center md:space-x-6">
                    <div class="flex space-x-3 mt-4 md:mt-0">
                        ...
                        <img src="{{asset('images/wechat.png')}}" alt="Amex" class="h-8">
                        <img src="{{asset('images/discover.png')}}" alt="Discover" class="h-8">
                        <img src="{{asset('images/Ali.png')}}" alt="Aliexpress" class="h-8">
{{--                        <img src="diners-club.png" alt="Diners Club" class="h-8">--}}
                    </div>
                </div>

                <a href="javascript:;"  class="py-2.5 mt-5 px-5 h-9 block w-fit bg-indigo-600 rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-indigo-700 lg:mx-0">
                    Contact us
                </a>
            </div>
            <!--End Col-->
            ...
            <div class="lg:mx-auto text-left ">
                ...
                <ul class="text-sm  transition-all duration-500">
                    <li class="mb-6"><a href="javascript:;"  class="text-gray-600 hover:text-gray-900">Writing</a></li>
                    <li class="mb-6"><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">ai checker</a></li>
                    <li><a href="javascript:;"  class=" text-gray-600 hover:text-gray-900">Plagiarism checker</a></li>
                </ul>
            </div>
            <!--End Col-->
            <div class="lg:mx-auto text-left ">
        ...
        <div class="py-7 border-t border-gray-200">
            <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                <span class="text-sm text-gray-500 ">©<a href="https://pagedone.io/">4scholars</a>
                    <script>
                        var d = new Date();
